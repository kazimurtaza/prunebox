        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Daily digest of your selected subscriptions
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="md:col-span-2">
                    <CardHeader>
                        <CardTitle>Subscriptions in Rollup</CardTitle>
                        <CardDescription>
                            {subscriptions.length} newsletters will be consolidated into your next digest
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {subscriptions.length > 0 ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-lg font-semibold">No subscriptions in rollup</h3>
                                <p className="text-muted-foreground mb-4">
                                    Go back to your dashboard and select "Rollup" for the newsletters you want to consolidate.
                                </p>
                ...
                <div className="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2">
                            <Button className="w-full" variant="outline">Send Test Digest</Button>
                            <Button className="w-full" variant="destructive" disabled={!settings?.enabled}>
                                Disable Rollup
                            </Button>
                        </CardContent>
                    </Card>
